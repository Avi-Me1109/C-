...
//Lab 8 - Question 1
//Date: 04-29-2022
//Diving Simulation with addition
...
class Diver
{
	...
	protected:
	float judge[7], final_score, judge_scores, a;
...
class DiverChild : public Diver
{
	...
	void disregard()
	{
		...
		if(a == 1)
		{
			cout << "Printing the final five judge scores\n";
			for(int i = 0; i < 7; i++)
			{
				if (get_score(i) == 0)
				{
...
int main()
{
	float a, b = 0, c = 0, d = 0, difficulty, counter;
